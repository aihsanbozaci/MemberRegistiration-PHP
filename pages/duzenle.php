...
<body>
<header class="baslik"><center><br><h2><b>Düzenleme Formu</b></h2></center><br></header>
...
<form class="well form-horizontal" method="POST"  id="contact_form" action="update.php">
<fieldset>
...
<input  name="first_name" placeholder="Adınızı giriniz." class="form-control"  type="text" value="<?php echo $sonuc['first_name'];?>">
</div>
</div>
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
<input name="last_name" placeholder="Soyadınızı giriniz." class="form-control"  type="text" value="<?php echo $sonuc['last_name'];?>">
</div>
</div>
</div>
...
<select name="gender" class="form-control selectpicker">
  <option value="<?php echo $sonuc['gender'];?>">Cinsiyet seçiniz.</option>
  <option>Kadın</option>
  <option>Erkek</option>
  <option>Diğer</option>
</select>
...
<div class="input-group">
<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
<input maxlength="11" name="validID" placeholder="" class="form-control"  type="number" maxlength="11" value="<?php echo $sonuc['validID'];?>">
</div>
</div>
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
<input name="job" placeholder="Mesleğinizi giriniz." class="form-control"  type="text" value="<?php echo $sonuc['job'];?>">
</div>
</div>
</div>
...
<input name="email" placeholder="E-Posta adresinizi giriniz." class="form-control"  type="text" value="<?php echo $sonuc['email'];?>">
</div>
</div>
</div>
...
<label class="col-md-2 control-label">Hakkınızda kısa bilgi </label>     <div ><textarea  class="asagikaydir"  name="bilgi" id="exampleFormControlTextarea1" rows="3" type="text" > <?php echo $sonuc['bilgi'];?> </textarea></div>
<div class="col-md-4 inputGroupContainer"  > 
<div class="input-group" > 
<span class="input-group-addon" ><i class="glyphicon glyphicon-user"></i></span>  
<input maxlength="10" name="telno"  class="form-control"  type="number" value="<?php echo $sonuc['telno'];?>"> <div class="form-group2" >
</div>
</div>
</div>
...
<input name="adres" placeholder="Adresinizi giriniz." class="form-control" type="text" value="<?php echo $sonuc['adres'];?>">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-md-4 inputGroupContainer">
<div class="input-group">
<input type="date" id="birthday" name="birthday" value="<?php echo $sonuc['birthday'];?>">
</div>
<br>
